---
title: Logic Profile
description: Generador avanzado de Volume, Delta y TPO (Market Profile) con periodos de sesión y personalizados.
order: 3
category: indicators
public: true
---
...
- **Volume & Delta Profiles** como barras horizontales o polígonos suaves (Geometry)
- **TPO (Market Profile)** con Letters, Blocks, o ambos
- **Área de Valor (VAH / VAL)** resaltando la zona del 70% de concentración
- **Point of Control (POC)** marcando el nivel de precio con mayor volumen
- **Initial Balance (IB)** línea vertical de los primeros X minutos de la sesión
- **Extensiones de líneas Naked / Infinity** que se cortan automáticamente cuando el precio las toca
