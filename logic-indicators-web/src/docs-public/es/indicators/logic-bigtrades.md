...
description: Visualización en tiempo real de las órdenes institucionales grandes que entran al mercado.
order: 5
category: indicators
public: true
---
...
- **Umbral de tamaño configurable** para filtrar el ruido minorista
- **Coloreado Bid/Ask** para ver al instante si el agresor fue comprador o vendedor
- **Múltiples estilos de visualización** (puntos, líneas, burbujas)
- **Alertas sonoras** cuando una operación por encima del umbral entra a tu gráfico
- **Reproducción histórica** para revisión post-sesión
