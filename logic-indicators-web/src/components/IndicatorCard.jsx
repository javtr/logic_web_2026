...
export const IndicatorCard = ({ title, subtitle, description, image, buttonText = 'Leer más' }) => (
  <div className="group relative p-8 rounded-2xl bg-dark-800 border border-dark-700 hover:border-accent-secondary/50 transition-all duration-500">
    <div className="absolute -inset-px rounded-2xl bg-gradient-to-b from-accent-secondary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
    <div className="relative">
      ...
      <div className="flex flex-col gap-4">
        {image && <ZoomableImage src={image} alt={title} className="w-full h-48 object-cover rounded-lg" />}
